...
describe('Assertions', function () {
    ...
    describe('#isBigNumber', function () {
        it('should not throw for valid input', function () {
            var validInputs = [
                new bignumber_js_1.BigNumber(23),
    ...
    describe('#isUndefined', function () {
        it('should not throw for valid input', function () {
            ...
            validInputs.forEach(function (input) { return expect(index_1.assert.isUndefined.bind(index_1.assert, input, variableName)).to.not.throw(); });
        });
        it('should throw for invalid input', function () {
            var invalidInputs = [
                'test',
            ...
            invalidInputs.forEach(function (input) { return expect(index_1.assert.isUndefined.bind(index_1.assert, input, variableName)).to.throw(); });
        });
    });
    ...
    describe('#isFunction', function () {
        it('should not throw for valid input', function () {
            var validInputs = [
                ...
                index_1.assert.isString.bind(_this),
            ];
    ...
    describe('#isETHAddressHex', function () {
        ...
        it('should throw for invalid input', function () {
            ...
            invalidInputs.forEach(function (input) {
                return expect(index_1.assert.isETHAddressHex.bind(index_1.assert, variableName, input)).to.throw();
            });
        });
    });
    ...
    describe('#isWeb3Provider', function () {
        it('should not throw for valid input', function () {
            var validInputs = [
                { send: function () { return 45; } },
                { sendAsync: function () { return 45; } },
            ];
            validInputs.forEach(function (input) {
        ...
        it('should throw for invalid input', function () {
            ...
            invalidInputs.forEach(function (input) {
                return expect(index_1.assert.isWeb3Provider.bind(index_1.assert, variableName, input)).to.throw();
            });
        });
    });
    ...
    describe('#isHttpUrl', function () {
        it('should not throw for valid input', function () {
            ...
            validInputs.forEach(function (input) {
                return expect(index_1.assert.isHttpUrl.bind(index_1.assert, variableName, input)).to.not.throw();
            });
        });
        it('should throw for invalid input', function () {
            var invalidInputs = [
            ...
            invalidInputs.forEach(function (input) {
                return expect(index_1.assert.isHttpUrl.bind(index_1.assert, variableName, input)).to.throw();
            });
        });
    });
    ...
    describe('#typeAssertionMessage', function () {
        it('should render correct message', function () {
            expect(index_1.assert.typeAssertionMessage('variable', 'string', 'number'))
