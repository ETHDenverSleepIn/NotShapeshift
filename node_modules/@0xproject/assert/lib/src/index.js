...
exports.assert = {
    ...
    isETHAddressHex: function (variableName, value) {
        ...
        this.assert(ethereum_address.isAddress(value) && value.toLowerCase() === value, "Checksummed addresses are not supported. Convert " + variableName + " to lower case before passing");
    },
