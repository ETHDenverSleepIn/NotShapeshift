...
var CancelOrder = /** @class */ (function (_super) {
    ...
    CancelOrder.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var order, err_1, signedOrder, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, new aqueduct_1.Aqueduct.Api.StandardService().getOrderByHash({
                    ...
                    case 2:
                        ...
                        throw err_1;
                    case 3:
                        signedOrder = aqueduct_1.Aqueduct.Utils.convertStandardOrderToSignedOrder(order);
                        _a.label = 4;
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, this.zeroEx.exchange.cancelOrderAsync(signedOrder, new bignumber_js_1.BigNumber(signedOrder.takerTokenAmount))];
