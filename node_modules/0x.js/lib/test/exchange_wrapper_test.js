...
describe('ExchangeWrapper', function () {
    ...
    describe('fillOrKill order(s)', function () {
        ...
        var takerAddress;
        var feeRecipient;
        var takerTokenFillAmount = new bignumber_js_1.default(5);
        before(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        describe('#batchFillOrKillAsync', function () {
            it('successfully batch fillOrKill', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            fillableAmount = new bignumber_js_1.default(5);
                            partialFillTakerAmount = new bignumber_js_1.default(2);
                        ...
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                orderFillRequests = [
                                    {
                                        signedOrder: signedOrder,
                                        takerTokenFillAmount: new bignumber_js_1.default(0),
                                    },
                                ];
                                return [2 /*return*/];
                        }
        ...
        describe('#fillOrKillOrderAsync', function () {
            ...
            describe('successful fills', function () {
                ...
                it('should partially fill a valid order', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_e) {
                        switch (_e.label) {
                            case 0:
                                partialFillAmount = new bignumber_js_1.default(3);
            ...
            describe('order transaction options', function () {
                var emptyFillableAmount = new bignumber_js_1.default(0);
                it('should validate when orderTransactionOptions are not present', function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
    ...
    describe('fill order(s)', function () {
        ...
        describe('#fillOrderAsync', function () {
            describe('successful fills', function () {
                ...
                it('should fill the valid orders with fees', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                makerFee = new bignumber_js_1.default(1);
            ...
            describe('order transaction options', function () {
                var signedOrder;
                var emptyFillTakerAmount = new bignumber_js_1.default(0);
                beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, fillScenarios.createFillableSignedOrderAsync(makerTokenAddress, takerTokenAddress, makerAddress, takerAddress, fillableAmount)];
        ...
        describe('#batchFillOrdersAsync', function () {
            ...
            describe('order transaction options', function () {
                beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        emptyFillTakerAmount = new bignumber_js_1.default(0);
                        orderFillBatch = [
                            {
                                signedOrder: signedOrder,
        ...
        describe('#fillOrdersUpTo', function () {
            ...
            describe('order transaction options', function () {
                var emptyFillUpToAmount = new bignumber_js_1.default(0);
                it('should validate when orderTransactionOptions are not present', function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
    ...
    describe('cancel order(s)', function () {
        ...
        describe('#cancelOrderAsync', function () {
            ...
            describe('order transaction options', function () {
                var emptyCancelTakerTokenAmount = new bignumber_js_1.default(0);
                it('should validate when orderTransactionOptions are not present', function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
        ...
        describe('#batchCancelOrdersAsync', function () {
            ...
            describe('order transaction options', function () {
                beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        emptyTakerTokenCancelAmount = new bignumber_js_1.default(0);
                        cancelBatch = [
                            {
                                order: signedOrder,
    ...
    describe('tests that require partially filled order', function () {
        ...
        before(function () {
            ...
            var makerToken = tokens[0], takerToken = tokens[1];
            makerTokenAddress = makerToken.address;
            takerTokenAddress = takerToken.address;
        });
        beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fillableAmount = new bignumber_js_1.default(5);
                        partialFillAmount = new bignumber_js_1.default(2);
    ...
    describe('#subscribe', function () {
        ...
        var fillableAmount;
        var signedOrder;
        var takerTokenFillAmountInBaseUnits = new bignumber_js_1.default(1);
        var cancelTakerAmountInBaseUnits = new bignumber_js_1.default(1);
        before(function () {
            coinbase = userAddresses[0], makerAddress = userAddresses[1], takerAddress = userAddresses[2];
            var makerToken = tokens[0], takerToken = tokens[1];
            makerTokenAddress = makerToken.address;
        ...
        it('Outstanding subscriptions are cancelled when zeroEx.setProvider called', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            callbackNeverToBeCalled = function (err, logEvent) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        signedOrder = _a.sent();
                        orderHash = src_1.ZeroEx.getOrderHashHex(signedOrder);
                        return [4 /*yield*/, zeroEx.exchange
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        indexFilterValues = {};
                        return [4 /*yield*/, zeroEx.exchange.getLogsAsync(eventName, subscriptionOpts, indexFilterValues)];
                    case 4:
                        logs = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        indexFilterValues = {};
                        return [4 /*yield*/, zeroEx.exchange.getLogsAsync(differentEventName, subscriptionOpts, indexFilterValues)];
                    case 4:
                        logs = _a.sent();
