...
describe('ExpirationWatcher', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    currentUnixTimestampSec = utils_1.utils.getCurrentUnixTimestampSec();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        callbackAsync = report_callback_errors_1.reportCallbackErrors(done)(function (hash) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                expect(hash).to.be.equal(orderHash);
                                expect(utils_1.utils.getCurrentUnixTimestampSec()).to.be.bignumber.gte(expirationUnixTimestampSec);
                                done();
                                return [2 /*return*/];
                            });
                        }); });
    ...
    it('emits events in correct order', function (done) {
        (function () { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            var order1Lifetime, order2Lifetime, order1ExpirationUnixTimestampSec, order2ExpirationUnixTimestampSec, signedOrder1, signedOrder2, orderHash1, orderHash2, expirationOrder, callbackAsync;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        order1Lifetime = 60;
                    ...
                    case 2:
                        ...
                        callbackAsync = report_callback_errors_1.reportCallbackErrors(done)(function (hash) { return __awaiter(_this, void 0, void 0, function () {
                            var orderHash;
                            return __generator(this, function (_a) {
                                orderHash = expirationOrder.shift();
                                expect(hash).to.be.equal(orderHash);
