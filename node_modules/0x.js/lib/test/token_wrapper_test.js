...
describe('TokenWrapper', function () {
    ...
    describe('#transferAsync', function () {
        ...
        before(function () {
            token = tokens[0];
            transferAmount = new bignumber_js_1.default(42);
        });
        it('should successfully transfer tokens', function () { return __awaiter(_this, void 0, void 0, function () {
            var fromAddress, toAddress, preBalance, txHash, receipt, postBalance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe('#transferFromAsync', function () {
        ...
        it('should throw a CONTRACT_DOES_NOT_EXIST error for a non-existent token contract', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                fromAddress = coinbase;
                nonExistentTokenAddress = '0x9dd402f14d67e001d8efbe6583e51bf9706aa065';
                return [2 /*return*/, expect(zeroEx.token.transferFromAsync(nonExistentTokenAddress, fromAddress, toAddress, senderAddress, new bignumber_js_1.default(42))).to.be.rejectedWith(src_1.ZeroExError.TokenContractDoesNotExist)];
            });
        }); });
    });
        ...
        describe('With web3 provider with accounts', function () {
            it('should return the balance for an existing ERC20 token', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            balance = _a.sent();
                            expectedBalance = new bignumber_js_1.default('1000000000000000000000000000');
            ...
            it('should throw a CONTRACT_DOES_NOT_EXIST error for a non-existent token contract', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    nonExistentTokenAddress = '0x9dd402f14d67e001d8efbe6583e51bf9706aa065';
                    ownerAddress = coinbase;
                    return [2 /*return*/, expect(zeroEx.token.getBalanceAsync(nonExistentTokenAddress, ownerAddress))
                            .to.be.rejectedWith(src_1.ZeroExError.TokenContractDoesNotExist)];
                });
            }); });
            it('should return a balance of 0 for a non-existent owner address', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            balance = _a.sent();
                            expectedBalance = new bignumber_js_1.default(0);
                            return [2 /*return*/, expect(balance).to.be.bignumber.equal(expectedBalance)];
                    }
                });
            }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expectedAllowanceBeforeAllowanceSet = new bignumber_js_1.default(0);
                        expect(allowanceBeforeSet).to.be.bignumber.equal(expectedAllowanceBeforeAllowanceSet);
                        amountInBaseUnits = new bignumber_js_1.default(50);
    ...
    describe('#setUnlimitedAllowanceAsync', function () {
        ...
        it('should reduce the gas cost for transfers including tokens with unlimited allowance support', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transferAmount = new bignumber_js_1.default(5);
            ...
            it('should return 0 if no allowance set yet', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            allowance = _a.sent();
                            expectedAllowance = new bignumber_js_1.default(0);
                            return [2 /*return*/, expect(allowance).to.be.bignumber.equal(expectedAllowance)];
                    }
                });
            }); });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            callbackToBeCalled = function (err, logEvent) {
                                done();
                            };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        indexFilterValues = {};
                        return [4 /*yield*/, zeroEx.token.getLogsAsync(tokenAddress, eventName, subscriptionOpts, indexFilterValues)];
                    case 3:
                        logs = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        indexFilterValues = {};
                        return [4 /*yield*/, zeroEx.token.getLogsAsync(tokenAddress, differentEventName, subscriptionOpts, indexFilterValues)];
                    case 3:
                        logs = _a.sent();
