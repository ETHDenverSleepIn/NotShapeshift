...
describe('ZeroEx library', function () {
    ...
    describe('#isValidSignature', function () {
        ...
        it('should return true if the signature does pertain to the dataHex & address', function () { return __awaiter(_this, void 0, void 0, function () {
            var isValidSignatureLocal, isValidSignatureOnContract;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        isValidSignatureOnContract = _a.sent();
                        return [2 /*return*/, expect(isValidSignatureOnContract).to.be.true()];
                }
            });
        }); });
    });
    describe('#generateSalt', function () {
        ...
        it('generates salt in range [0..2^256)', function () {
            ...
            var twoPow256 = new bignumber_js_1.default(2).pow(256);
    ...
    describe('#toUnitAmount', function () {
        it('Should return the expected unit amount for the decimals passed in', function () {
            var baseUnitAmount = new bignumber_js_1.default(1000000000);
            var decimals = 6;
            var unitAmount = src_1.ZeroEx.toUnitAmount(baseUnitAmount, decimals);
            var expectedUnitAmount = new bignumber_js_1.default(1000);
    ...
    describe('#toBaseUnitAmount', function () {
        it('Should return the expected base unit amount for the decimals passed in', function () {
            var unitAmount = new bignumber_js_1.default(1000);
            var decimals = 6;
            var baseUnitAmount = src_1.ZeroEx.toBaseUnitAmount(unitAmount, decimals);
            var expectedUnitAmount = new bignumber_js_1.default(1000000000);
    ...
    describe('#getOrderHashHex', function () {
        ...
        var order = {
            ...
            salt: new bignumber_js_1.default(0),
            makerFee: new bignumber_js_1.default(0),
            takerFee: new bignumber_js_1.default(0),
            makerTokenAmount: new bignumber_js_1.default(0),
            takerTokenAmount: new bignumber_js_1.default(0),
            expirationUnixTimestampSec: new bignumber_js_1.default(0),
        };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        stubs = [
                            Sinon.stub(zeroEx._web3Wrapper, 'signTransactionAsync')
    ...
    describe('#config', function () {
        ...
        it('allows to specify ether token contract address', function () { return __awaiter(_this, void 0, void 0, function () {
            var zeroExConfig, zeroExWithWrongEtherTokenAddress;
            return __generator(this, function (_a) {
                zeroExConfig = {
                    etherTokenContractAddress: src_1.ZeroEx.NULL_ADDRESS,
                    networkId: constants_1.constants.TESTRPC_NETWORK_ID,
                };
                zeroExWithWrongEtherTokenAddress = new src_1.ZeroEx(web3.currentProvider, zeroExConfig);
                expect(zeroExWithWrongEtherTokenAddress.etherToken.getContractAddress()).to.be.equal(src_1.ZeroEx.NULL_ADDRESS);
                return [2 /*return*/];
            });
        }); });
        it('allows to specify token registry token contract address', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                expect(zeroExWithWrongTokenRegistryAddress.tokenRegistry.getContractAddress())
                    .to.be.equal(src_1.ZeroEx.NULL_ADDRESS);
                return [2 /*return*/];
            });
        }); });
    });
