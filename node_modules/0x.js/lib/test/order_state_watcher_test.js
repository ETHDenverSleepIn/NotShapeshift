...
describe('OrderStateWatcher', function () {
    ...
    var fillableAmount = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(5), decimals);
    ...
    describe('tests with cleanup', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            it('should emit orderStateValid when watched order partially filled', function (done) {
                (function () { return __awaiter(_this, void 0, void 0, function () {
                    var makerBalance, takerBalance, fillAmountInBaseUnits, orderHash, callback, shouldThrowOnInsufficientBalanceOrAllowance;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, fillScenarios.createFillableSignedOrderAsync(makerToken.address, takerToken.address, maker, taker, fillableAmount)];
                            case 1:
            ...
            describe('remainingFillable(M|T)akerTokenAmount', function () {
                it('should calculate correct remaining fillable', function (done) {
                    (function () { return __awaiter(_this, void 0, void 0, function () {
                        var takerFillableAmount, makerFillableAmount, makerBalance, takerBalance, fillAmountInBaseUnits, orderHash, callback, shouldThrowOnInsufficientBalanceOrAllowance;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    takerFillableAmount = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(10), decimals);
                                    makerFillableAmount = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(20), decimals);
                                ...
                                case 3:
                                    takerBalance = _a.sent();
                                    fillAmountInBaseUnits = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(2), decimals);
                                    orderHash = src_1.ZeroEx.getOrderHashHex(signedOrder);
                                    zeroEx.orderStateWatcher.addOrder(signedOrder);
                                    callback = report_callback_errors_1.reportCallbackErrors(done)(function (orderState) {
                                        expect(orderState.isValid).to.be.true();
                                        ...
                                        expect(validOrderState.orderHash).to.be.equal(orderHash);
                                        var orderRelevantState = validOrderState.orderRelevantState;
                                        expect(orderRelevantState.remainingFillableMakerTokenAmount).to.be.bignumber.equal(src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(16), decimals));
                                        expect(orderRelevantState.remainingFillableTakerTokenAmount).to.be.bignumber.equal(src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(8), decimals));
                                        done();
                                    });
                                    zeroEx.orderStateWatcher.subscribe(callback);
                                    shouldThrowOnInsufficientBalanceOrAllowance = true;
                    ...
                    (function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    makerBalance = _a.sent();
                                    changedMakerApprovalAmount = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(3), decimals);
                                    zeroEx.orderStateWatcher.addOrder(signedOrder);
                                    callback = report_callback_errors_1.reportCallbackErrors(done)(function (orderState) {
                                        var validOrderState = orderState;
                                        var orderRelevantState = validOrderState.orderRelevantState;
                    ...
                    (function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    makerBalance = _a.sent();
                                    remainingAmount = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(1), decimals);
                ...
                it('should equal remaining amount when partially cancelled and order has fees', function (done) {
                    (function () { return __awaiter(_this, void 0, void 0, function () {
                        var takerFee, makerFee, feeRecipient, makerBalance, remainingTokenAmount, transferTokenAmount, callback;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    takerFee = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(0), decimals);
                                    makerFee = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(5), decimals);
                                    feeRecipient = taker;
                                ...
                                case 2:
                                    makerBalance = _a.sent();
                                    remainingTokenAmount = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(4), decimals);
                ...
                it('should equal ratio amount when fee balance is lowered', function (done) {
                    (function () { return __awaiter(_this, void 0, void 0, function () {
                        var takerFee, makerFee, feeRecipient, makerBalance, remainingFeeAmount, transferFeeAmount, remainingTokenAmount, transferTokenAmount, callback;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    takerFee = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(0), decimals);
                                ...
                                case 2:
                                    makerBalance = _a.sent();
                                    remainingFeeAmount = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(3), decimals);
                                    transferFeeAmount = makerFee.sub(remainingFeeAmount);
                                    remainingTokenAmount = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(4), decimals);
                                    transferTokenAmount = makerFee.sub(remainingTokenAmount);
                                    zeroEx.orderStateWatcher.addOrder(signedOrder);
                                    callback = report_callback_errors_1.reportCallbackErrors(done)(function (orderState) {
                ...
                it('should calculate full amount when all available and non-divisible', function (done) {
                    (function () { return __awaiter(_this, void 0, void 0, function () {
                        var takerFee, makerFee, feeRecipient, makerBalance, callback;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    takerFee = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(0), decimals);
                                    makerFee = src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(2), decimals);
                                    feeRecipient = taker;
                                    return [4 /*yield*/, fillScenarios.createFillableSignedOrderWithFeesAsync(makerToken.address, takerToken.address, makerFee, takerFee, maker, taker, fillableAmount, feeRecipient)];
                                case 1:
                                    signedOrder = _a.sent();
                                ...
                                case 2:
                                    ...
                                    zeroEx.orderStateWatcher.subscribe(callback);
                                    return [4 /*yield*/, zeroEx.token.setProxyAllowanceAsync(makerToken.address, maker, src_1.ZeroEx.toBaseUnitAmount(new bignumber_js_1.default(100), decimals))];
                                case 3:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
