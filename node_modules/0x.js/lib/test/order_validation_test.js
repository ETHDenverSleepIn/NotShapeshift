...
describe('OrderValidation', function () {
    ...
    var fillableAmount = new bignumber_js_1.default(5);
    var fillTakerAmount = new bignumber_js_1.default(5);
    var config = {
    ...
    describe('validateOrderFillableOrThrowAsync', function () {
        ...
        it('should throw when order is expired', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        expirationInPast = new bignumber_js_1.default(1496826058);
    ...
    describe('validateFillOrderAndThrowIfInvalidAsync', function () {
        it('should throw when the fill amount is zero', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        signedOrder = _a.sent();
                        zeroFillAmount = new bignumber_js_1.default(0);
        ...
        it('should throw when there a rounding error would have occurred', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        makerAmount = new bignumber_js_1.default(3);
                        takerAmount = new bignumber_js_1.default(5);
                    ...
                    case 1:
                        signedOrder = _a.sent();
                        fillTakerAmountThatCausesRoundingError = new bignumber_js_1.default(3);
        ...
        it('should throw if remaining fillAmount is less then the desired fillAmount', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        signedOrder = _a.sent();
                        tooLargeFillAmount = new bignumber_js_1.default(7);
    ...
    describe('validateCancelOrderAndThrowIfInvalidAsync', function () {
        var signedOrder;
        var orderHashHex;
        var cancelAmount = new bignumber_js_1.default(3);
        beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, makerToken, takerToken;
            return __generator(this, function (_b) {
                switch (_b.label) {
        ...
        it('should throw when cancel amount is zero', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                zeroCancelAmount = new bignumber_js_1.default(0);
    ...
    describe('#validateFillOrderBalancesAllowancesThrowIfInvalidAsync', function () {
        ...
        it('should call exchangeTransferSimulator.transferFrom in a correct order', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        makerFee = new bignumber_js_1.default(2);
                        takerFee = new bignumber_js_1.default(2);
                    ...
                    case 2:
                        ...
                        expect(transferFromAsync.getCall(0).calledWith(makerTokenAddress, makerAddress, takerAddress, bigNumberMatch(fillableAmount), types_1.TradeSide.Maker, types_1.TransferType.Trade)).to.be.true();
                        expect(transferFromAsync.getCall(1).calledWith(takerTokenAddress, takerAddress, makerAddress, bigNumberMatch(fillableAmount), types_1.TradeSide.Taker, types_1.TransferType.Trade)).to.be.true();
                        expect(transferFromAsync.getCall(2).calledWith(zrxTokenAddress, makerAddress, feeRecipient, bigNumberMatch(makerFee), types_1.TradeSide.Maker, types_1.TransferType.Fee)).to.be.true();
                        expect(transferFromAsync.getCall(3).calledWith(zrxTokenAddress, takerAddress, feeRecipient, bigNumberMatch(takerFee), types_1.TradeSide.Taker, types_1.TransferType.Fee)).to.be.true();
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        makerFee = new bignumber_js_1.default(2);
                        takerFee = new bignumber_js_1.default(2);
                        return [4 /*yield*/, fillScenarios.createFillableSignedOrderWithFeesAsync(makerTokenAddress, takerTokenAddress, makerFee, takerFee, makerAddress, src_1.ZeroEx.NULL_ADDRESS, fillableAmount, feeRecipient)];
                    case 1:
                        signedOrder = _a.sent();
                        return [4 /*yield*/, order_validation_utils_1.OrderValidationUtils.validateFillOrderBalancesAllowancesThrowIfInvalidAsync(exchangeTransferSimulator, signedOrder, fillableAmount, takerAddress, zrxTokenAddress)];
                    case 2:
        ...
        it('should correctly round the fillMakerTokenAmount', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        makerTokenAmount = new bignumber_js_1.default(3);
                        takerTokenAmount = new bignumber_js_1.default(1);
        ...
        it('should correctly round the makerFeeAmount', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        makerFee = new bignumber_js_1.default(2);
                        takerFee = new bignumber_js_1.default(4);
                        return [4 /*yield*/, fillScenarios.createFillableSignedOrderWithFeesAsync(makerTokenAddress, takerTokenAddress, makerFee, takerFee, makerAddress, takerAddress, fillableAmount, src_1.ZeroEx.NULL_ADDRESS)];
                    case 1:
                        signedOrder = _a.sent();
