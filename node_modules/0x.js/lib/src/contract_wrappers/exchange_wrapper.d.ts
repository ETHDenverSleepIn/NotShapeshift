...
import { DecodedLogArgs, EventCallback, ExchangeContractEventArgs, ExchangeEvents, IndexedFilterValues, LogWithDecodedArgs, MethodOpts, Order, OrderCancellationRequest, OrderFillRequest, OrderTransactionOpts, SignedOrder, SubscriptionOpts, ValidateOrderFillableOpts } from '../types';
...
export declare class ExchangeWrapper extends ContractWrapper {
     ...
     */
    getLogsAsync<ArgsType extends ExchangeContractEventArgs>(eventName: ExchangeEvents, subscriptionOpts: SubscriptionOpts, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
    /**
