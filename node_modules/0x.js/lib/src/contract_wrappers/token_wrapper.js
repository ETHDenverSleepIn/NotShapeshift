...
var ALLOWANCE_TO_ZERO_GAS_AMOUNT = 47275;
/**
...
var TokenWrapper = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        // Wrap BigNumbers returned from web3 with our own (later) version of BigNumber
                        allowanceInBaseUnits = new bignumber_js_1.default(allowanceInBaseUnits);
     ...
     */
    TokenWrapper.prototype.getLogsAsync = function (tokenAddress, eventName, subscriptionOpts, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._getLogsAsync(tokenAddress, eventName, subscriptionOpts, indexFilterValues, artifacts_1.artifacts.TokenArtifact.abi)];
                    case 1:
                        logs = _a.sent();
