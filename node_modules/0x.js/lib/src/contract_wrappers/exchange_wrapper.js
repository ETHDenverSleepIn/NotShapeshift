...
var ExchangeWrapper = /** @class */ (function (_super) {
    ...
    function ExchangeWrapper(web3Wrapper, networkId, abiDecoder, tokenWrapper, contractAddressIfExists) {
        ...
        _this._orderValidationUtils = new order_validation_utils_1.OrderValidationUtils(tokenWrapper, _this);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        unavailableTakerTokenAmount = new bignumber_js_1.default(unavailableTakerTokenAmount);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        // Wrap BigNumbers returned from web3 with our own (later) version of BigNumber
                        fillAmountInBaseUnits = new bignumber_js_1.default(fillAmountInBaseUnits);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        // Wrap BigNumbers returned from web3 with our own (later) version of BigNumber
                        cancelledAmountInBaseUnits = new bignumber_js_1.default(cancelledAmountInBaseUnits);
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        shouldValidate = _.isUndefined(orderTransactionOpts.shouldValidate) ?
                            ...
                            orderTransactionOpts.shouldValidate;
                        if (!shouldValidate) return [3 /*break*/, 4];
                        orderHash = utils_1.utils.getOrderHashHex(order);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        orderHash = utils_1.utils.getOrderHashHex(orderCancellationRequest.order);
                        return [4 /*yield*/, this.getUnavailableTakerAmountAsync(orderHash)];
                    case 3:
                        unavailableTakerTokenAmount = _b.sent();
     ...
     */
    ExchangeWrapper.prototype.getLogsAsync = function (eventName, subscriptionOpts, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.doesBelongToStringEnum('eventName', eventName, types_1.ExchangeEvents);
                        assert_1.assert.doesConformToSchema('subscriptionOpts', subscriptionOpts, json_schemas_1.schemas.subscriptionOptsSchema);
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        exchangeContractAddress = this.getContractAddress();
                        return [4 /*yield*/, this._getLogsAsync(exchangeContractAddress, eventName, subscriptionOpts, indexFilterValues, artifacts_1.artifacts.ExchangeArtifact.abi)];
                    case 1:
                        logs = _a.sent();
    ...
    __decorate([
        decorators_1.decorators.contractCallErrorHandler
