...
import { EventCallback, IndexedFilterValues, LogWithDecodedArgs, MethodOpts, SubscriptionOpts, TokenContractEventArgs, TokenEvents, TransactionOpts } from '../types';
...
export declare class TokenWrapper extends ContractWrapper {
     ...
     */
    getLogsAsync<ArgsType extends TokenContractEventArgs>(tokenAddress: string, eventName: TokenEvents, subscriptionOpts: SubscriptionOpts, indexFilterValues: IndexedFilterValues): Promise<Array<LogWithDecodedArgs<ArgsType>>>;
