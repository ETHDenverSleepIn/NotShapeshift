...
var OrderFilledCancelledLazyStore = /** @class */ (function () {
    function OrderFilledCancelledLazyStore(exchange) {
    ...
    OrderFilledCancelledLazyStore.prototype.getFilledTakerAmountAsync = function (orderHash) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!_.isUndefined(this.filledTakerAmount[orderHash])) return [3 /*break*/, 2];
                        methodOpts = {
                            defaultBlock: types_1.BlockParamLiteral.Pending,
                        };
                        return [4 /*yield*/, this.exchange.getFilledTakerAmountAsync(orderHash, methodOpts)];
                    case 1:
                        filledTakerAmount = _a.sent();
                        this.setFilledTakerAmount(orderHash, filledTakerAmount);
                        _a.label = 2;
                    case 2:
                        cachedFilled = this.filledTakerAmount[orderHash];
    ...
    OrderFilledCancelledLazyStore.prototype.getCancelledTakerAmountAsync = function (orderHash) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!_.isUndefined(this.cancelledTakerAmount[orderHash])) return [3 /*break*/, 2];
                        methodOpts = {
                            defaultBlock: types_1.BlockParamLiteral.Pending,
                        };
                        return [4 /*yield*/, this.exchange.getCancelledTakerAmountAsync(orderHash, methodOpts)];
                    case 1:
                        cancelledTakerAmount = _a.sent();
                        this.setCancelledTakerAmount(orderHash, cancelledTakerAmount);
                        _a.label = 2;
                    case 2:
                        cachedCancelled = this.cancelledTakerAmount[orderHash];
