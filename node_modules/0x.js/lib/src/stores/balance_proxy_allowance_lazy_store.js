    ...
    BalanceAndProxyAllowanceLazyStore.prototype.getBalanceAsync = function (tokenAddress, userAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(_.isUndefined(this.balance[tokenAddress]) || _.isUndefined(this.balance[tokenAddress][userAddress]))) return [3 /*break*/, 2];
                        methodOpts = {
                            defaultBlock: this.defaultBlock,
                        };
                        return [4 /*yield*/, this.token.getBalanceAsync(tokenAddress, userAddress, methodOpts)];
                    case 1:
                        balance = _a.sent();
                        this.setBalance(tokenAddress, userAddress, balance);
                        _a.label = 2;
                    case 2:
                        cachedBalance = this.balance[tokenAddress][userAddress];
                ...
                switch (_a.label) {
                    case 0:
                        if (!(_.isUndefined(this.proxyAllowance[tokenAddress]) ||
                            _.isUndefined(this.proxyAllowance[tokenAddress][userAddress]))) return [3 /*break*/, 2];
                        methodOpts = {
                            defaultBlock: this.defaultBlock,
                        };
                        return [4 /*yield*/, this.token.getProxyAllowanceAsync(tokenAddress, userAddress, methodOpts)];
                    case 1:
                        proxyAllowance = _a.sent();
                        this.setProxyAllowance(tokenAddress, userAddress, proxyAllowance);
                        _a.label = 2;
                    case 2:
                        cachedProxyAllowance = this.proxyAllowance[tokenAddress][userAddress];
