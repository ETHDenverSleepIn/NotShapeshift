...
var OrderStateUtils = /** @class */ (function () {
    ...
    OrderStateUtils.validateIfOrderIsValid = function (signedOrder, orderRelevantState) {
    ...
    OrderStateUtils.prototype.getOrderRelevantStateAsync = function (signedOrder) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        exchange = this.orderFilledCancelledLazyStore.exchange;
                        zrxTokenAddress = exchange.getZRXTokenAddress();
                        orderHash = _0x_1.ZeroEx.getOrderHashHex(signedOrder);
                        return [4 /*yield*/, this.balanceAndProxyAllowanceLazyStore.getBalanceAsync(signedOrder.makerTokenAddress, signedOrder.maker)];
                    case 1:
                        makerBalance = _a.sent();
                        return [4 /*yield*/, this.balanceAndProxyAllowanceLazyStore.getProxyAllowanceAsync(signedOrder.makerTokenAddress, signedOrder.maker)];
                    case 2:
                        makerProxyAllowance = _a.sent();
                        return [4 /*yield*/, this.balanceAndProxyAllowanceLazyStore.getBalanceAsync(zrxTokenAddress, signedOrder.maker)];
                    case 3:
                        makerFeeBalance = _a.sent();
                        return [4 /*yield*/, this.balanceAndProxyAllowanceLazyStore.getProxyAllowanceAsync(zrxTokenAddress, signedOrder.maker)];
                    case 4:
                        makerFeeProxyAllowance = _a.sent();
                        return [4 /*yield*/, this.orderFilledCancelledLazyStore.getFilledTakerAmountAsync(orderHash)];
                    case 5:
                        filledTakerTokenAmount = _a.sent();
                        return [4 /*yield*/, this.orderFilledCancelledLazyStore.getCancelledTakerAmountAsync(orderHash)];
                    case 6:
                    ...
                    case 7:
                        ...
                        remainingMakerTokenAmount = remainingTakerTokenAmount.times(totalMakerTokenAmount)
                            .dividedToIntegerBy(totalTakerTokenAmount);
                        transferrableMakerTokenAmount = bignumber_js_1.default.min([makerProxyAllowance, makerBalance]);
                        transferrableFeeTokenAmount = bignumber_js_1.default.min([makerFeeProxyAllowance, makerFeeBalance]);
