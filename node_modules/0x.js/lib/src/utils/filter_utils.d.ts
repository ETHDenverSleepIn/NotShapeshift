...
export declare const filterUtils: {
    generateUUID(): string;
    getFilter(address: string, eventName: ContractEvents, indexFilterValues: IndexedFilterValues, abi: Web3.AbiDefinition[], subscriptionOpts?: SubscriptionOpts | undefined): Web3.FilterObject;
