...
exports.utils = {
    ...
    getOrderHashHex: function (order) {
        var orderParts = [
            ...
            { value: exports.utils.bigNumberToBN(order.makerTokenAmount), type: types_1.SolidityTypes.Uint256 },
            { value: exports.utils.bigNumberToBN(order.takerTokenAmount), type: types_1.SolidityTypes.Uint256 },
            { value: exports.utils.bigNumberToBN(order.makerFee), type: types_1.SolidityTypes.Uint256 },
            { value: exports.utils.bigNumberToBN(order.takerFee), type: types_1.SolidityTypes.Uint256 },
            { value: exports.utils.bigNumberToBN(order.expirationUnixTimestampSec), type: types_1.SolidityTypes.Uint256 },
    ...
    getCurrentUnixTimestampSec: function () {
        return new bignumber_js_1.default(Date.now() / 1000).round();
    },
