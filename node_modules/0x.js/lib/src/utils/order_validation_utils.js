...
var OrderValidationUtils = /** @class */ (function () {
    function OrderValidationUtils(tokenWrapper, exchangeWrapper) {
    ...
    OrderValidationUtils.validateFillOrderBalancesAllowancesThrowIfInvalidAsync = function (exchangeTradeEmulator, signedOrder, fillTakerTokenAmount, senderAddress, zrxTokenAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fillMakerTokenAmount = OrderValidationUtils.getPartialAmount(fillTakerTokenAmount, signedOrder.takerTokenAmount, signedOrder.makerTokenAmount);
                    ...
                    case 2:
                        _a.sent();
                        makerFeeAmount = OrderValidationUtils.getPartialAmount(fillTakerTokenAmount, signedOrder.takerTokenAmount, signedOrder.makerFee);
                    ...
                    case 3:
                        _a.sent();
                        takerFeeAmount = OrderValidationUtils.getPartialAmount(fillTakerTokenAmount, signedOrder.takerTokenAmount, signedOrder.takerFee);
    ...
    OrderValidationUtils.validateRemainingFillAmountNotZeroOrThrow = function (takerTokenAmount, unavailableTakerTokenAmount) {
        if (takerTokenAmount.eq(unavailableTakerTokenAmount)) {
            throw new Error(types_1.ExchangeContractErrs.OrderRemainingFillAmountZero);
        }
    };
    OrderValidationUtils.validateOrderNotExpiredOrThrow = function (expirationUnixTimestampSec) {
        var currentUnixTimestampSec = utils_1.utils.getCurrentUnixTimestampSec();
        if (expirationUnixTimestampSec.lessThan(currentUnixTimestampSec)) {
            throw new Error(types_1.ExchangeContractErrs.OrderFillExpired);
        }
    };
    OrderValidationUtils.getPartialAmount = function (numerator, denominator, target) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.exchangeWrapper.getUnavailableTakerAmountAsync(orderHash)];
                    case 1:
                        unavailableTakerTokenAmount = _a.sent();
                        OrderValidationUtils.validateRemainingFillAmountNotZeroOrThrow(signedOrder.takerTokenAmount, unavailableTakerTokenAmount);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.exchangeWrapper.isRoundingErrorAsync(filledTakerTokenAmount, signedOrder.takerTokenAmount, signedOrder.makerTokenAmount)];
                    case 3:
