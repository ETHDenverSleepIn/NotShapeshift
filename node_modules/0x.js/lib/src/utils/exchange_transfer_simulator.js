...
var ExchangeTransferSimulator = /** @class */ (function () {
    function ExchangeTransferSimulator(token, defaultBlock) {
        this.store = new balance_proxy_allowance_lazy_store_1.BalanceAndProxyAllowanceLazyStore(token, defaultBlock);
        this.UNLIMITED_ALLOWANCE_IN_BASE_UNITS = token.UNLIMITED_ALLOWANCE_IN_BASE_UNITS;
    }
    ExchangeTransferSimulator.throwValidationError = function (failureReason, tradeSide, transferType) {
    ...
    ExchangeTransferSimulator.prototype.transferFromAsync = function (tokenAddress, from, to, amountInBaseUnits, tradeSide, transferType) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.store.getBalanceAsync(tokenAddress, from)];
                    case 1:
                        balance = _a.sent();
                        return [4 /*yield*/, this.store.getProxyAllowanceAsync(tokenAddress, from)];
                    case 2:
                        ...
                        return [4 /*yield*/, this.decreaseProxyAllowanceAsync(tokenAddress, from, amountInBaseUnits)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.decreaseBalanceAsync(tokenAddress, from, amountInBaseUnits)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.increaseBalanceAsync(tokenAddress, to, amountInBaseUnits)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ExchangeTransferSimulator.prototype.decreaseProxyAllowanceAsync = function (tokenAddress, userAddress, amountInBaseUnits) {
        return __awaiter(this, void 0, void 0, function () {
            var proxyAllowance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.store.getProxyAllowanceAsync(tokenAddress, userAddress)];
                    case 1:
                        proxyAllowance = _a.sent();
    ...
    ExchangeTransferSimulator.prototype.increaseBalanceAsync = function (tokenAddress, userAddress, amountInBaseUnits) {
        return __awaiter(this, void 0, void 0, function () {
            var balance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.store.getBalanceAsync(tokenAddress, userAddress)];
                    case 1:
                        balance = _a.sent();
    ...
    ExchangeTransferSimulator.prototype.decreaseBalanceAsync = function (tokenAddress, userAddress, amountInBaseUnits) {
        return __awaiter(this, void 0, void 0, function () {
            var balance;
            return __generator(this, function (_a) {
                switch (_a.label) {
