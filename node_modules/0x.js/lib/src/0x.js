...
var ZeroEx = /** @class */ (function () {
    ...
    function ZeroEx(provider, config) {
        ...
        this.exchange = new exchange_wrapper_1.ExchangeWrapper(this._web3Wrapper, config.networkId, this._abiDecoder, this.token, config.exchangeContractAddress);
        ...
        this.etherToken = new ether_token_wrapper_1.EtherTokenWrapper(this._web3Wrapper, config.networkId, this.token, config.etherTokenContractAddress);
    ...
    ZeroEx.generatePseudoRandomSalt = function () {
        ...
        var randomNumber = bignumber_js_1.default.random(constants_1.constants.MAX_DIGITS_IN_UNSIGNED_256_INT);
        var factor = new bignumber_js_1.default(10).pow(constants_1.constants.MAX_DIGITS_IN_UNSIGNED_256_INT - 1);
