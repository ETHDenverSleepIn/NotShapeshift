...
var OrderStateWatcher = /** @class */ (function () {
    function OrderStateWatcher(web3Wrapper, abiDecoder, token, exchange, config) {
        ...
        var expirationMarginIfExistsMs = _.isUndefined(config) ?
            undefined :
    ...
    OrderStateWatcher.prototype.removeOrder = function (orderHash) {
        ...
        var exchange = this._orderFilledCancelledLazyStore.exchange;
    ...
    OrderStateWatcher.prototype.subscribe = function (callback) {
        ...
        this._cleanupJobIntervalIdIfExists = interval_utils_1.intervalUtils.setAsyncExcludingInterval(this._cleanupAsync.bind(this), this._cleanupJobInterval);
    };
    /**
    ...
    OrderStateWatcher.prototype.unsubscribe = function () {
        ...
        interval_utils_1.intervalUtils.clearAsyncExcludingInterval(this._cleanupJobIntervalIdIfExists);
    };
    ...
    OrderStateWatcher.prototype._onEventWatcherCallbackAsync = function (log) {
        return __awaiter(this, void 0, void 0, function () {
            var maybeDecodedLog, isLogDecoded, decodedLog, makerToken, makerAddress, _a, args, orderHashes, args, orderHashes, args, orderHash, isOrderWatched, args, orderHash, isOrderWatched;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case types_1.ExchangeEvents.LogFill: return [3 /*break*/, 7];
                            case types_1.ExchangeEvents.LogCancel: return [3 /*break*/, 10];
                            case types_1.ExchangeEvents.LogError: return [3 /*break*/, 13];
                        }
                        return [3 /*break*/, 14];
                    case 1:
                    ...
                    case 7:
                        ...
                        if (!isOrderWatched) return [3 /*break*/, 9];
                        return [4 /*yield*/, this._emitRevalidateOrdersAsync([orderHash])];
                    case 8:
                        _b.sent();
                        _b.label = 9;
                    ...
                    case 10:
                        ...
                        orderHash = args.orderHash;
                        isOrderWatched = !_.isUndefined(this._orderByOrderHash[orderHash]);
                        if (!isOrderWatched) return [3 /*break*/, 12];
                        return [4 /*yield*/, this._emitRevalidateOrdersAsync([orderHash])];
                    case 11:
                        _b.sent();
                        _b.label = 12;
                    case 12: return [3 /*break*/, 15];
                    case 13: return [2 /*return*/]; // noop
                    case 14: throw utils_1.utils.spawnSwitchErr('decodedLog.event', decodedLog.event);
    ...
    OrderStateWatcher.prototype.addToDependentOrderHashes = function (signedOrder, orderHash) {
    ...
    OrderStateWatcher.prototype.removeFromDependentOrderHashes = function (makerAddress, tokenAddress, orderHash) {
