...
var EventWatcher = /** @class */ (function () {
    ...
    EventWatcher.prototype.subscribe = function (callback) {
        ...
        this._intervalIdIfExists = interval_utils_1.intervalUtils.setAsyncExcludingInterval(this._pollForBlockchainEventsAsync.bind(this, callback), this._pollingIntervalMs);
    };
    EventWatcher.prototype.unsubscribe = function () {
        this._lastEvents = [];
        if (!_.isUndefined(this._intervalIdIfExists)) {
            interval_utils_1.intervalUtils.clearAsyncExcludingInterval(this._intervalIdIfExists);
