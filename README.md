Submission to EthDenver hackathon 2018. 0x and ErcDex bounty winner. Currently runs on 0x provided testrpc in their stater-project, but working on migration to Kovan test network. Run the testrpc at port 8545 and run `npm start` at the directory level to run. 
## Table of Contents
